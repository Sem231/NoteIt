...
const ClientId =
  '72666822427-n1ftuiobcguef6pi3k0ndomlft0l11lb.apps.googleusercontent.com';
...
const SignIn = () => {
  ...
  const onSubmit = async (values: any, { setSubmitting, resetForm }: any) => {
    ...
    await axios
      .post('https://noteit-server-1.onrender.com/login', Info)
      .then((res) => {
  ...
  const postGoogle = async (email) => {
    await axios
      .post(`https://noteit-server-1.onrender.com/glogin`, { Email: email })
      .then((res) => {
        localStorage.setItem('_ttt_', res.data.token);
        localStorage.setItem('email', res.data.user);
        navigate('/space');
                ...
                {({
                  ...
                  <form onSubmit={handleSubmit}>
                    <div className="mb-4">
                      ...
                      <ErrorMessage
                        className="font-serif pl-1 pt-1 font-medium text-[#FF0000]"
                        name="email"
                        component="div"
                      />
                    </div>
